...
**Buyer UI:** native **Leasegrid Sync** (Gridsync-lineage PyQt wrap + Magic Folder). Tahoe WUI is not the product. See [`docs/09-ui-track.md`](docs/09-ui-track.md) and [`docs/design/14-U0-DEVBOT-HANDOFF.md`](docs/design/14-U0-DEVBOT-HANDOFF.md).
